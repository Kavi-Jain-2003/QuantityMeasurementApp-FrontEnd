  ...
  template: `
    <div class="form-card">
      ...
      <div class="field">
        ...
        <!-- Strength bar -->
        <div class="str-bar">
          <div class="str-fill" [style.width]="strength().pct" [style.background]="strength().color"></div>
        </div>
      ...
      <p class="switch-txt">Already have an account? <a routerLink="/auth/login">Sign in</a></p>
    </div>
  `
})
